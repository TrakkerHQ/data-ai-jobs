#!/usr/bin/env python3
"""Pull Trakker's Data, Research (AI/ML) postings and regenerate the README tables.

Runs once a day from .github/workflows/refresh.yml. Each run:

1. fetches every Data / Research (AI/ML) intern/new-grad posting Trakker considers new in the
...
CATEGORIES = ['Data', 'Research (AI/ML)']
...
def fetch() -> list[dict]:
    ...
    request = urllib.request.Request(url, headers={
        ...
        "User-Agent": "trakker-data-ai-jobs/1.0 (+https://github.com/TrakkerHQ/data-ai-jobs)",
    })
    try:
